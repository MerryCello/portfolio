...
var toggleDracula = () => {
   ...
   for(const section of sections) {
      // Dark mode on
      if (hasClass(section, "bg-highlight")) {
         section.classList.remove("bg-highlight");
         section.classList.add("dark-bg-highlight");
      }
      // Dark mode off
      else if (hasClass(section, "dark-bg-highlight")) {
         section.classList.remove("dark-bg-highlight");
...
const hasClass = (element, className) => {
   for(const classN of element.classList) {
      if (classN == className)
      return true
   }
